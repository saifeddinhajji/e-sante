    ...
    <div class="content">
        <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">list de forums en atende</li>
            </ol>
          </nav>
          <div class="row">
            <div class="col-md-9">
             ...
             <div class="col-md-3">
             <form action="{{route('serachforum')}}" method="POST">  @csrf <input type="hidden" name="pagename"  value="admin.listforumentende"> <input type="hidden" name="etat" value="atende"><input class="form-control left" name="search" type="text" placeholder="titre" aria-label="Search">      </form> 
             </div>
             <br>
  </div>
         <br>
