    ...
    <div class="content">
        <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">list de forums</li>
            </ol>
          </nav>
          <div class="row">
            <div class="col-md-9">
             ...
             <div class="col-md-3">
             <form action="{{route('serachforum')}}" method="POST">  @csrf <input type="hidden" name="pagename"  value="admin.listforum"> <input type="hidden" name="etat" value=""><input class="form-control left" name="search" type="text" placeholder="(titre,sujet,description....)" aria-label="Search">      </form> 
             </div>
             <br>
  </div>
         <br>
                                ...
                                <tbody>
                                    @if(!empty($allforum))
                                            ...
                                            <tr>
                                                ...
                                                <td >
                                                 @if($forum->etat=="atende")
                                                <a href="{{route('accepteforum',$forum->id)}}"> <i class="fas fa-check-square" style="font-weight: 600;color:#008000"></i></a>
                                                <a href="{{route('refuseforum',$forum->id)}}">   <i class="fas fa-minus-circle" style="font-weight: 600;color:red"></i></a>
                                                @endif
                                                @if($forum->etat=="refuse")
                                                <a href="{{route('accepteforum',$forum->id)}}"> <i class="fas fa-check-square" style="font-weight: 600;color:#008000"></i></a>
                                                @endif
