...
<div  style="background-color:white;padding:5px"  style="height :100%"   >
    ...
    <div class="alert alert-success" role="alert">
     ...
     @endif
            <form  action="{{route('updateforum',$forum->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label >Titre <sub style="font-size: xx-large;color:red;">*</sub></label>
                           <input type="text" name="titre"  value="{{$forum->titre}}" class="form-control" required>
                        </div>
                        @if ($errors->has('titre'))
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="sujet" value="{{$forum->sujet}}" class="form-control" required>
                        </div>
                        @if ($errors->has('sujet'))
                            <span class="invalid-feedback" style="display: block;" role="alert">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text"  name="urlvideo" value="{{$forum->urlvideo}}" class="form-control" >
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control"  name="description" rows="5" required>{{$forum->description}}</textarea>
